      ...
      "terms": {
        "field": "status.keyword"
                        ...
                        <el-tab-pane label="索引操作">
                            <div class="example-section">
                                <h4>1. 创建索引</h4>
                                <pre class="example-code">PUT /my_index
{
  "settings": {
    "number_of_shards": 3,
  ...
  "mappings": {
    "properties": {
      ...
      "createTime": { "type": "date" }
                                ...
                                <h4>2. 查看映射</h4>
                                <pre class="example-code">GET /my_index/_mapping</pre>

                                <h4>3. 删除索引</h4>
                                <pre class="example-code">DELETE /my_index</pre>
                            </div>
                        </el-tab-pane>
                        ...
                        <el-tab-pane label="其他操作">
                            <div class="example-section">
                                <h4>1. 集群健康</h4>
                                <pre class="example-code">GET /_cluster/health</pre>

                                <h4>2. 节点信息</h4>
                                <pre class="example-code">GET /_nodes</pre>

                                <h4>3. 索引列表</h4>
                                <pre class="example-code">GET /_cat/indices?v&format=json</pre>

                                <h4>4. 批量操作</h4>
                                <pre class="example-code">POST /_bulk
